...
class SM4App(ctk.CTk):
    ...
    def _build_text_tab(self):
        ...
        def toggle_text_info():
            ...
            if self.show_text_info:
                ...
                toggle_btn.configure(text="▼ Приховати інструкцію")
            else:
                self.text_info_box.pack_forget()
                toggle_btn.configure(text="▶ Показати інструкцію")
        
        toggle_btn = CTkButton(info_btn_frame, text="▶ Показати інструкцію", 
        ...
        info_title = CTkLabel(self.text_info_box, text="ℹ️ Як користуватися режимом Текст", 
                             font=("Segoe UI", 12, "bold"), text_color=self.text_color)
        ...
        in_lbl = CTkLabel(in_header, text="📝 Вхідний текст", font=("Segoe UI", 13, "bold"))
        ...
        self.text_input = CTkTextbox(in_sec, height=130, font=("Segoe UI", 12))
        ...
        key_lbl = CTkLabel(key_header, text="🔑 Ключ шифрування", font=("Segoe UI", 13, "bold"))
        ...
        out_lbl = CTkLabel(out_header, text="📤 Результат (HEX формат)", font=("Segoe UI", 13, "bold"))
        ...
        self.text_output = CTkTextbox(out_sec, height=160, font=("Courier", 12))
    ...
    def _build_file_tab(self):
        ...
        file_lbl = CTkLabel(file_header, text="📁 Вибір файлу", font=("Segoe UI", 13, "bold"))
        ...
        key_lbl = CTkLabel(key_header, text="🔑 Управління ключем", font=("Segoe UI", 13, "bold"))
        key_lbl.pack(side="left")
